        ...
        <div class="tab">
            <table>
                <tr style="color: white">
                    ...
                    <td>联系方式</td>
                    <td>发布时间</td>
                    <td style="font-size: 14px">修改 <span> 删除</span></td>
                </tr>
            </table>
        </div>
    </div>
        ...
        <div class="tab">
            <table>
                ...
                <tr>
                    ...
                    <td><a href="change.jsp?id=<%=e.getId()%>">修改</a>
                        <a href="javascript:if(confirm('确实要删除该内容吗?删除后不可恢复。')){location='delete.jsp?id=<%=e.getId()%>'}">删除</a>
                    </td>
                </tr>
                <%
                        }
